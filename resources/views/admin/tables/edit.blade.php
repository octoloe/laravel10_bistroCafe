...
<div class="container">
    ...
    <h3 class="text-center">Einen Tisch Aktualisieren</h3>
    ...
    <div class="card shadow mt-3 mx-5 p-3 rounded">
        <form action="{{ route('admin.tables.update', $table->id) }}" method="POST">
            ...
            <div class="mb-5">
                ...
                <input type="text" class="form-control @error('name') is-invalid @enderror" value="{{ $table->name }}"
                    name="name" id="name" placeholder="Coffee Ipsum" />
            ...
            <div class="mb-5">
                ...
                <input type="number" class="form-control @error('guest_number') is-invalid @enderror"
                    value="{{ $table->guest_number }}" name="guest_number" id="guest_number"
