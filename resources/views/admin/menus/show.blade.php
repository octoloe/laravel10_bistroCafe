...
<div class="container">
    ...
    <div class="d-flex justify-content-center mt-5">
        <div class="card shadow" style="width: 20rem;">
            <img src="{{ Storage::url($menu->image) }}" class="card-img-top" width="" />
            <div class="card-body">
                <h5 class="card-title text-center mt-3">{{ $menu->name }}</h5>
                <p class="card-text">
                    {{ $menu->description }}
                </p>
                ...
                <div class="btn-group">
                    <a href="{{ route('admin.menus.edit', $menu->id) }}" class="btn btn-outline-warning btn-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
