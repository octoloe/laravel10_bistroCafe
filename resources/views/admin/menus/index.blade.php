...
<div class="container">
    ...
    <h1 class="text-center">Spezialitäten</h1>

    <div class="row">
        <div class="d-flex justify-content-end mt-5">
            <a href="{{ route('admin.menus.create') }}" class="btn btn-outline-success btn-sm">
            ...
            <table class="table table-hover">
                ...
                <tbody class="table-group-divider">
                    ...
                    <tr>
                        ...
                        <td>
                            <img src="{{ Storage::url($menu->image) }}" class="w-25 rounded" />
                        </td>
                        <td>{{ $menu->name }}</td>
                        <td>{{ $menu->price }}€</td>
